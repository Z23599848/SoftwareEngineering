...
Source: [classDiagram.md](../design/diagrams/classDiagram.md)
<!-- START_CLASS_DIAGRAM -->
```mermaid
classDiagram
class User {
...
Source: [sequenceDiagram.md](../design/diagrams/sequenceDiagram.md)
...
Source: [edr_diagram.md](../design/diagrams/edr_diagram.md)
<!-- START_ER_DIAGRAM -->
```mermaid
erDiagram
